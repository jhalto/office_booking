                                            ...
                                            children: [
                                              ...
                                              Expanded(flex:2,child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                  children: [
                                                    Text("${officeInfo!['data']['data'][index]['location']}",style: whiteStyle(),),
                                                    Text("${officeInfo!['data']['data'][index]['city']}",style: whiteStyle(),),
                                                    SizedBox(height: 5,),
                                                    Row(
                                                      children: [
                                                        Container(
                                                          ...
                                                          child: Text("${officeInfo!['data']['data'][index]['capacity']} PERSON"),
                                                        ),
                                                        SizedBox(width: 10,),
                                                        Container(
                                                          padding: EdgeInsets.only(left: 5,right: 5,top: 3,bottom: 3),
                                                          ...
                                                          child: Text("${double.parse(officeInfo!['data']['data'][index]['distance'].toString()).toStringAsFixed(2)} km"),
                                                        ),
                                                      ],
                                                    )
                                                  ],
